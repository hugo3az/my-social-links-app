...
import droneAnimation from "../Components/Animacoes/Drone.json"
...
export default function ColorfulSocialLinks() {
    const socialLinks = [

        {
            name: 'WhatsApp',
            icon: FaWhatsapp,
            url: 'https://wa.me/5588999848335', // Número de telefone formatado
            description: 'WhatsApp / Orçamentos',
            color: '#25D366',
            hoverColor: '#1DA851',
        },

        {
            name: 'Instagram',
            icon: Instagram,
            url: 'https://instagram.com/caique.freitas_',
        ...
        },
        {
            name: 'Contato',
            icon: Phone,
            url: 'tel:88999848335', // Número de telefone para a chamada
        ...
        },
        {
            name: 'Facebook',
            icon: Facebook,
            url: 'https://facebook.com/cayke.freitas',
            description: 'Conecte-se no Facebook',
            color: '#4267B2',
            hoverColor: '#365899'
        },
    ];
                    ...
                    <VStack spacing="4">
                        <VStack spacing={2} align="start">  {/* VStack para organizar um abaixo do outro */}
                            <Text fontSize="18px">
                                ...
                                <Text>° ACOMPANHAMENTO DE OBRAS</Text>
                                <Text>° MERCADO IMOBILIÁRIO</Text>
                                <Text>° EVENTOS EM GERAL</Text>
                            </Text>
                        </VStack>
                                ...
                                >
                                    <HStack align="center" spacing={4} w="full">
                                        ...
                                        <Box position="absolute" right={-10} top={-5}> {/* Posiciona o drone */}
                                            <Lottie animationData={droneAnimation} loop={true} style={{ width: '80px', height: '80px' }} />
                                        </Box>
                                    </HStack>
                                </Button>
                            ))}
